...
-- ----------------------------
-- Sequence structure for doctors_doctorid_seq
-- ----------------------------
DROP SEQUENCE IF EXISTS "public"."doctors_doctorid_seq";
...
CREATE TABLE "public"."appointments" (
  ...
  "appointmentdate" timestamp(0),
  "contactnumber" varchar(100) COLLATE "pg_catalog"."default",
  "doctor" varchar(255) COLLATE "pg_catalog"."default",
  "prescription" varchar(255) COLLATE "pg_catalog"."default",
  "history" varchar(255) COLLATE "pg_catalog"."default"
)
;
...
-- ----------------------------
INSERT INTO "public"."appointments" VALUES (13, 'kk, kk', '2024-02-12 13:10:00', '09269440075', 'Charles Xavier2- Brains', 'sample', 'sample');
...
CREATE TABLE "public"."doctors" (
  "doctorid" int4 NOT NULL DEFAULT nextval('doctors_doctorid_seq'::regclass),
  "doctorname" varchar(100) COLLATE "pg_catalog"."default",
...
-- Records of doctors
-- ----------------------------
INSERT INTO "public"."doctors" VALUES (3, 'Charles Xavier2', 'Nuerology', 'Brains', '1231231', '2024-02-09');
...
-- Records of patients
-- ----------------------------
INSERT INTO "public"."patients" VALUES (5, 'kk', 'sss', 'kk', 'Daang manunuso st. ibayo Tipas', 'dd', '9269440075', 'sads', 'High Blood', '2024-02-09');
...
SELECT setval('"public"."appointments_appointmentid_seq"', 13, true);

-- ----------------------------
-- Alter sequences owned by
-- ----------------------------
ALTER SEQUENCE "public"."doctors_doctorid_seq"
OWNED BY "public"."doctors"."doctorid";
SELECT setval('"public"."doctors_doctorid_seq"', 3, true);
...
SELECT setval('"public"."patients_patientid_seq"', 5, true);
...
-- ----------------------------
ALTER TABLE "public"."doctors" ADD CONSTRAINT "doctors_pkey" PRIMARY KEY ("doctorid");
